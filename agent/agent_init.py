...
def init_agent(
    ...
    if api_mode in {"chat_completions", "codex_responses", "anthropic_messages", "bedrock_converse", "codex_app_server", "gemini_cli"}:
    ...
    if agent.api_mode == "anthropic_messages":
        ...
        agent._client_kwargs = {}
        if not agent.quiet_mode:
            print(f"🤖 AI Agent initialized with model: {agent.model} (Gemini CLI)")
